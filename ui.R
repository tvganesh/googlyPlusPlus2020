...
shinyUI(fluidPage(
  ...
  ## Title and headings
  titlePanel("GooglyPlusPlus 2020!!!"),
  h5("GooglyPlusPlus"),
  ...
  navlistPanel(
    ...
    tabPanel("About GooglyPlusPlus 2020",h3("GooglyPlusPlus 2020 - Analyzing ODI,T20 Players, teams and matches with plots and tables"),
             ...
             p("This Shiny app 'GooglyPlusPlus' has been designed and developed by  Tinniam V Ganesh, Dec 14 2020"),
